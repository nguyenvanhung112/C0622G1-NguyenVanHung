...
public class BlogerServiceIplm implements IBlogerService {
    ...
    @Override
    public List<Bloger> find() {
        return blogerRepository.findAll();
    }

    @Override
    public List<Bloger> findByCategory(int categoryId) {
        return blogerRepository.findByCategory(categoryId);
    }

    @Override
    public List<Bloger> search(String search) {
        return blogerRepository.search(search);
    }
}
